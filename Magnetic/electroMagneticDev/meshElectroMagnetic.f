...
c              Write(*,*)idy
              ...
              Enddo
              Enddo
              Write(*,*)'Call creatTemMesh'
              Return
              End Subroutine

              Subroutine electroCalculationMeshInfo
              Implicit None
              Integer(kind=4)::i,j
              ...
              y(num_xtem,num_ytem)=yc(num_xtem,num_ytem)
              x(1,num_ytem)=xc(2,num_ytem)
              y(1,num_ytem)=yc(2,num_ytem)
              x(num_xtem,1)=xc(num_xtem,2)
              y(num_xtem,1)=yc(num_xtem,2)
...
c calcaulate areas on the control-volume faces(staggered grids)
              ...
              Enddo
              Enddo
c annulus areas and volume (2pai)
              Do i=1,num_xtem
              Do j=1,num_ytem
              ...
              Enddo
              Enddo
              Write(*,*)'Call electroCalculationMeshInfo'
c check meshinfo
              Open(10,file='meshinfo.dat')
              Write(10,20180)
              Write(10,20181)num_xtem,num_ytem
              Write(10,20182)((y(i,j),i=1,num_xtem),j=1,num_ytem)
              Write(10,20182)((x(i,j),i=1,num_xtem),j=1,num_ytem)
              Write(10,20182)((vol(i,j),i=1,num_xtem),j=1,num_ytem)
20180 format(1x,'variables="x","y","vol"') 
20181 format(1x,'zone t="zone 1", i=',i3,' , j=',i3,' , f=block')
20182 format(6(1pe12.5,1x))
              Close(10)
c              Stop
              Return
              End Subroutine
